...
public class ImpiegatoDAOImpl extends AbstractMySQLDAO implements ImpiegatoDAO {
	// andrò ad effettuare la connessione al data base
	...
	public List<Impiegato> list() throws Exception {
		// se la connessione non adrà a buon fine mi bloccherà il programma attraverso
		// un eccezione
		if (isNotActive())
			throw new Exception("Connessione non attiva. Impossibile effettuare operazioni DAO.");

		List<Impiegato> result = new ArrayList<Impiegato>();
		// diciaro la query per l'estrazione dei dati dal db
	...
	// metodo che andrà ad aggiornare un valore nel db
	public int update(Impiegato input) throws Exception {
		if (isNotActive())// nel caso la connessione non va a buon fine lancerà un eccezione
			throw new Exception("Connessione non attiva. Impossibile effettuare operazioni DAO.");
